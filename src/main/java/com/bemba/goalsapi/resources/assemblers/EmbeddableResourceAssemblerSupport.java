/**
 * @Copyright opencredo
 * @Url https://github.com/opencredo/spring-hateoas-sample
 */
...
public abstract class EmbeddableResourceAssemblerSupport<T, D extends ResourceSupport, C>
	...
	/**
	 * Create a wrapped representation of a collection, to be added to the _embedded
	 * Resources of the containing resource It relies on the embedded resource being
	 * annotated with {@link Relation} and the collection of embedded objects being
	 * annotated with {@link JsonUnwrapped} (see
	...
	/**
	 * Create an empty main object wrapping a list of resources. This is the way HAL
	 * expects endpoint returning a collection works
	 */
	...
	public abstract Resources<D> toEmbeddedListWithId(Iterable<T> entities, Long id);
